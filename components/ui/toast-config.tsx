...
export const toastConfig = {
  success: (props: ToastConfigParams<any>) => (
    <View className="w-[90%] max-w-[420px] flex-row items-center rounded-2xl bg-surface px-4 py-4 shadow-sm">
      ...
      <TouchableOpacity
        onPress={() => Toast.hide()}
        className="rounded-full p-1 active:bg-gray-100 dark:active:bg-gray-800"
  ...
  error: (props: ToastConfigParams<any>) => (
    <View className="w-[90%] max-w-[420px] flex-row items-center rounded-2xl bg-surface px-4 py-3 shadow-sm">
